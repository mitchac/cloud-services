...
def prepare_header():
    ...
    token = os.popen('gcloud auth application-default login && gcloud auth --account=terra-api@maximal-dynamo-308105.iam.gserviceaccount.com print-access-token').read().rstrip()
